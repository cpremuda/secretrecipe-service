...
function YourLogger (component) {
    ...
    this.info = function (msg) {
        console.info('%s: %s', this.component, JSON.stringify(msg));
    };
    this.warn = function (msg) {
        console.warn('%s: %s', this.component, JSON.stringify(msg));
    };
    this.error = function (msg) {
        console.error('%s: %s', this.component, JSON.stringify(msg));
    };
    this.fatal = function (msg) {
        console.error('FATAL %s: %s', this.component, JSON.stringify(msg));
    };
}
